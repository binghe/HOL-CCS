...
cardinality of ``\HOLinline{\ensuremath{\beta} \HOLTyOp{Label}}''  \hlD{depends on its type variable:
...
\end{alltt}  
For instance, \hlD{the following proposition
need the above \emph{cases} theorem}:
\begin{alltt}
