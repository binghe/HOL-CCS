...
\HOLTokenTurnstile{} \HOLConst{CCS_Subst} \HOLFreeVar{E} (\HOLSymConst{\ensuremath{\mu}} \HOLFreeVar{X} \HOLFreeVar{E}) \HOLFreeVar{X} \HOLTokenTransBegin\HOLFreeVar{u}\HOLTokenTransEnd \HOLFreeVar{E\sb{\mathrm{1}}} \HOLSymConst{\HOLTokenImp{}} \HOLSymConst{\ensuremath{\mu}} \HOLFreeVar{X} \HOLFreeVar{E} \HOLTokenTransBegin\HOLFreeVar{u}\HOLTokenTransEnd \HOLFreeVar{E\sb{\mathrm{1}}}\hfill\texttt{[REC]}
\end{alltt}
...
\begin{alltt}
\HOLConst{CCS_Subst} \HOLConst{nil} \HOLFreeVar{E} \HOLFreeVar{X} \HOLSymConst{\HOLTokenDefEquality{}} \HOLConst{nil}
...
\HOLConst{CCS_Subst} (\HOLConst{var} \HOLFreeVar{Y}) \HOLFreeVar{E} \HOLFreeVar{X} \HOLSymConst{\HOLTokenDefEquality{}} \HOLKeyword{if} \HOLFreeVar{Y} \HOLSymConst{=} \HOLFreeVar{X} \HOLKeyword{then} \HOLFreeVar{E} \HOLKeyword{else} \HOLConst{var} \HOLFreeVar{Y}
