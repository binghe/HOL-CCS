...
\begin{alltt}
[\HOLFreeVar{E}/\HOLFreeVar{X}] \HOLConst{nil} \HOLSymConst{\HOLTokenDefEquality{}} \HOLConst{nil}
[\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] (\HOLFreeVar{u}\HOLSymConst{..}\HOLFreeVar{E}) \HOLSymConst{\HOLTokenDefEquality{}} \HOLFreeVar{u}\HOLSymConst{..}[\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] \HOLFreeVar{E}
[\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] (\HOLFreeVar{E\sb{\mathrm{1}}} \HOLSymConst{\ensuremath{+}} \HOLFreeVar{E\sb{\mathrm{2}}}) \HOLSymConst{\HOLTokenDefEquality{}} [\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] \HOLFreeVar{E\sb{\mathrm{1}}} \HOLSymConst{\ensuremath{+}} [\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] \HOLFreeVar{E\sb{\mathrm{2}}}
[\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] (\HOLFreeVar{E\sb{\mathrm{1}}} \HOLSymConst{\ensuremath{\parallel}} \HOLFreeVar{E\sb{\mathrm{2}}}) \HOLSymConst{\HOLTokenDefEquality{}} [\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] \HOLFreeVar{E\sb{\mathrm{1}}} \HOLSymConst{\ensuremath{\parallel}} [\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] \HOLFreeVar{E\sb{\mathrm{2}}}
[\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] (\HOLSymConst{\ensuremath{\nu}} \HOLFreeVar{L} \HOLFreeVar{E}) \HOLSymConst{\HOLTokenDefEquality{}} \HOLSymConst{\ensuremath{\nu}} \HOLFreeVar{L} ([\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] \HOLFreeVar{E})
[\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] (\HOLConst{relab} \HOLFreeVar{E} \HOLFreeVar{f}) \HOLSymConst{\HOLTokenDefEquality{}} \HOLConst{relab} ([\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] \HOLFreeVar{E}) \HOLFreeVar{f}
[\HOLFreeVar{E}/\HOLFreeVar{X}] (\HOLConst{var} \HOLFreeVar{Y}) \HOLSymConst{\HOLTokenDefEquality{}} \HOLKeyword{if} \HOLFreeVar{Y} \HOLSymConst{=} \HOLFreeVar{X} \HOLKeyword{then} \HOLFreeVar{E} \HOLKeyword{else} \HOLConst{var} \HOLFreeVar{Y}
[\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] (\HOLConst{rec} \HOLFreeVar{Y} \HOLFreeVar{E}) \HOLSymConst{\HOLTokenDefEquality{}} \HOLKeyword{if} \HOLFreeVar{Y} \HOLSymConst{=} \HOLFreeVar{X} \HOLKeyword{then} \HOLConst{rec} \HOLFreeVar{Y} \HOLFreeVar{E} \HOLKeyword{else} \HOLConst{rec} \HOLFreeVar{Y} ([\HOLFreeVar{E\sp{\prime}}/\HOLFreeVar{X}] \HOLFreeVar{E})\hfill{[CCS_Subst_def]}
\end{alltt}
