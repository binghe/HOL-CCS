...
\end{equation*}
\item \hl{\emph{ind} is the induction principle for the
...
\end{alltt}
\hl{The variable substitutions only affects free
...
\hl{This shows the usefulness of appealing to an ML function
