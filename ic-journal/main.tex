...
\tnotetext[mytitlenote]{\hlD{This is an extended and refined
 version of the paper with
  the same title published} in EXPRESS/SOS 2018~\cite{EPTCS276.10}.}
...
%(both univariate and multivariate versions)
