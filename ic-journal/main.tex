...
%\newcommand{\hl}[1]{{\underline{#1}}} % added DS
...
\tnotetext[mytitlenote]{This is an extended and refined
...
\begin{keyword}
process calculi \sep theorem proving \sep coinduction \sep unique
solution of equations \sep congruence
\end{keyword}

\end{frontmatter}

% for reviewers (disabled for uploading to editorialmanager.com/yinco, which adds its own line numbers)
% \linenumbers
