...
\begin{abstract}
  ...
  \hl{which must be weakly-guarded in Sangiorgi's work as the contraction
  ...
  (hence also the bisimilarity itself) while requires (true) weak
  guardness (with direct sums).
  We also prove that, rooted contraction is the coarsest
  precongruence contained in the contraction preorder, just like the
  case of rooted bisimilarity being the coarsest congruence contained
