...
Such structural similarities can be found, for instance, in the % editorial changes
...
Finally, in Sections~\ref{s:rel} and \ref{s:concl} we discuss the related work, % editorial
