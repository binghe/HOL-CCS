...
In particular, \hlD{the existing result}~\cite{sangiorgi2017equations} \hlD{has  limitations} on the body of the contractions due to the
...
Section~\ref{s:for} highlights our formalisation in HOL4 \hlD{for the
univariate case.}
Section~\ref{sec:multivariate} \hlD{describes the move to the
  multivariate case}. 
