...
\hl{A} highlight of this formalization project is the simplified definitions of
  bisimilarities using the new coinductive \hl{relation} package of
...
\end{alltt}
\item \hl{\emph{coind} is the coinduction principle for the relation.}
\begin{alltt}
...
% laws). 
The first \hl{five of them are proven} by constructing \hl{appropriate} bisimulation
