...
% basis. 
We recall that we often write $P \;\R\; Q$ to denote
...
\end{alltt}
\end{definition}
Note that the formal represention of $\sim \S \approx$ is
``\HOLinline{\HOLConst{WEAK_EQUIV} \HOLSymConst{\HOLTokenRCompose{}} \HOLFreeVar{Wbsm} \HOLSymConst{\HOLTokenRCompose{}} \HOLConst{STRONG_EQUIV}}'' where the order of
