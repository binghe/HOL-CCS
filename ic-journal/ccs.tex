...
process $P$ are the elements of the set $\{P' \st P \arr\mu P' \mbox{
 ...
 \DS{and $\alpha, \mu$  to range over all actions.}
\begin{figure*}[t]
\begin{center}
\vskip .1cm
...
\DS{We let $\R$, $\S$ range over binary relations, sometimes using 
 infix notation for them; e.g., 
$P \RR Q$ means that $(P,Q) \in \R$.}
We use \DS{a tilde, as in  $\til P$, to denote tuples of processes with
