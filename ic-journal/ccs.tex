...
The class of CCS processes is inductively
defined from $\nil$ \hl{(deadlock)} by the operators
of prefixing, parallel composition, summation (binary choice),
restriction, relabeling and recursion:
\begin{equation*}
\begin{array}{cccl}
...
The symmetric version of the two \hl{SOS} rules for
