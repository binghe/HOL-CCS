...
given CCS term $E$ as \HOLinline{\HOLConst{BV} \HOLFreeVar{E}}, and the set of all free
variables as \HOLinline{\HOLConst{FV} \HOLFreeVar{E}}. In HOL, both \HOLinline{\HOLConst{BV}} and \HOLinline{\HOLConst{FV}} have the
type ``\HOLinline{\ensuremath{(}\ensuremath{\alpha}, \ensuremath{\beta}\ensuremath{)} \HOLTyOp{CCS} \HOLTokenTransEnd \ensuremath{\alpha} \HOLTokenTransEnd \HOLTyOp{bool}}''. Milner didn't give their definitions
explicitly, however, 
