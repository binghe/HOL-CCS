...
In this section,  we describe the formalisation of the \multivariate
...
The work is a \hl{natural} extension of the \univariate case, as
...
\hl{Thus the same} variable can appear both \emph{bound} and \emph{free} in
a CCS term.
%
...
type ``\HOLinline{\ensuremath{(}\ensuremath{\alpha}, \ensuremath{\beta}\ensuremath{)} \HOLTyOp{CCS} \HOLTokenTransEnd \ensuremath{\alpha} \HOLTokenTransEnd \HOLTyOp{bool}}'', i.e. functions taking CCS terms and returning sets of
