...
because they well illustrate the \hlD{effort} needed in the \multivariate case.
...
The substitution mechanism is order-independent, \hlD{as based
 maps.} For most CCS operators it
just recursively calls itself on subterms.  \hlD{The} most
...
\hlD{For this, intuitively,  we replace a single variable with a hole and (viewing
...
we focus on each (free) variable: if we substitute each
