...
\hlD{The work is an extension of the univariate case}~\cite{EPTCS276.10}
...
\begin{alltt}
   \HOLTokenTurnstile{} \HOLConst{ALL_PROC} \HOLFreeVar{Es} \HOLSymConst{\HOLTokenEquiv{}} \HOLConst{EVERY} \HOLConst{IS_PROC} \HOLFreeVar{Es}\hfill{[ALL_PROC_def]}
\end{alltt}
