...
substitution of $E\{\til P/\til X\}$ which substitutes each \hl{possible
occurrence} of free variables $X_i$ in $E$ with the corresponding
...
Recall \hl{that} in Section~\ref{ss:context}, \univariate contexts and their
