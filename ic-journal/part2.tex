...
\begin{theorem}[\texttt{STRONG_UNIQUE_SOLUTION}, Proposition 3.14
  of~\cite{Mil89}, \univariate version]
...
For the proof of Theorem~\ref{t:Mil89s3}, we have used a different
...
\end{alltt}
In this proof, we did not use any ``bisimulation up-to'' technique.
With the above lemma, the next results can be proved by directly
constructing the required bisimulation:
...
\hl{Since} weak bisimilarity is not a congruence, we have to be more restrictive
