...
the only property \hl{one needed} from (rooted) contraction is the precongruence.
Below is the formal version of Theorem~\ref{t:rcontraBisimulationU}
(\texttt{UNIQUE_SOLUTION_OF_ROOTED_CONTRACTIONS}):
\begin{alltt}
...
\texttt{WG} in place of \texttt{WGS} (cf.~Theorem~\ref{thm:Mil89f}, \texttt{WEAK_UNIQUE_SOLUTION}).
