...
substituted for $X$:
\begin{lemma}[Lemma 3.13 of \cite{Mil89}, the univariate version]
\label{lem:313}
...
\end{alltt}
\end{theorem}
In \hl{the proof of the above theorem}, we have identified 14 major sub-goals, dividing them into 7
