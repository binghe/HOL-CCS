...
\end{alltt}
\DS{To construct this process $k$,}
...
\end{itemize}
\end{definition}
\DS{When processes are finite-state, that is,
...
\end{alltt}
\item  \DS{Any transition from a Klop process leads to a smaller Klop
...
\begin{proposition}
\DS{If $p$ has a  weak transition onto $q$,} then $q$ must be in the node set of $p$:
\begin{alltt}
...
\DS{For any two finite-state CCS $p$ and $q$, there exists another process $k$, which
...
\HOLTokenTurnstile{} \HOLSymConst{\HOLTokenForall{}}\HOLBoundVar{p} \HOLBoundVar{q}.
       ...
       \HOLSymConst{\HOLTokenExists{}}\HOLBoundVar{k}.
           ...
           \HOLSymConst{\HOLTokenForall{}}\HOLBoundVar{q\sp{\prime}} \HOLBoundVar{u}. \HOLBoundVar{q} \HOLTokenWeakTransBegin\HOLBoundVar{u}\HOLTokenWeakTransEnd \HOLBoundVar{q\sp{\prime}} \HOLSymConst{\HOLTokenImp{}} \HOLSymConst{\HOLTokenNeg{}}(\HOLBoundVar{q\sp{\prime}} \HOLSymConst{\HOLTokenWeakEQ} \HOLBoundVar{k})
\end{alltt}
\end{lemma}
