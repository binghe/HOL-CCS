...
In this subsection we discuss two proofs of \DDS{the fundamental  result} stating that
...
\DDS{The formal proofs  of the above two results  follow Milner's proof
...
\DDS{The proof, in the section below, uses extensively HOL's
...
\DDS{This can be done following Klop's contruction \cite{van2005characterisation}.}
...
\DDS{if $A$ is finite, $B$ is infinite, and all elements
...
\DDS{For any two finite-state CCS $p$ and $q$, there is another process
