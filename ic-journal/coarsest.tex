...
type variables $\alpha$ and $\beta$, if the type of all label
...
will be given later. We start with a core lemma saying that, for
any two processes $p$ and $q$, if there exists a \emph{stable} (i.e.~$\tau$-free)
 ...
 ($\rapprox$) (see~\cite{van2005characterisation,Tian:2017wrba} for its proof):
\begin{alltt}
