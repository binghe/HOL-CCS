...
% This theorem is of special \hl{interest} to us, because under our
% \hl{CCS syntax (with only binary summations)} it seems impossible to
% prove it without any \hl{antecedent such as ``the involved processes
%   do not use up all available labels''}.
...
%  we do not discuss free and bound names (also
% called ``sorts'') of CCS processes. Instead, 
we 
