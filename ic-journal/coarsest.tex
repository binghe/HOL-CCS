...
\begin{proposition}[\hl{$\rapprox$ is the coarsest congruence contained in $\wb$}]
\label{prop:coarsest}
\begin{equation}
...
Below we show how Proposition~\ref{prop:coarsest} is connected with
...
The proof of above theorem was given by Rob van Glabbeek
