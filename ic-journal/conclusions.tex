...
\DDS{The formalisation supports  4 methods for establishing (strong and weak) bisimilarity
results: 
\begin{enumerate}
\item
...
and proofs for different equivalences and preorders. \DS{Indeed we have
