...
\hlD{Her work has been a
 basis for ours.} However, the differences are substantial, especially in the way of defining
...
he has formalized basic properties for strong/weak equivalence (congruence, basic
 algebraic laws); \hlD{however the CCS syntax doesn't have constants
