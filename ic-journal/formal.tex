...
in the HOL theorem
prover (HOL4) \cite{Melham:1993vl,slind2008brief},
...
%(The situation is quite different in other systems like
%Coq\footnote{The Coq Proof Assistant. \url{https://coq.inria.fr}}).
\begin{enumerate}
...
%% [Chun]: cancelled this part as now we have multivariate formal proofs!
% \emph{In this
...
%  multi-variable case is just a routine adaptation, while the
%  formalisation in theorem prover % \DDS{}
