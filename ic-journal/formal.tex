...
\hl{HOL is a formal system of typed logical terms. The types are expressions that denote sets (in the
...
be correct. \hl{This is also the case here: SOS rules of CCS are
\emph{not} axioms but consequences of an inductive relation.}
