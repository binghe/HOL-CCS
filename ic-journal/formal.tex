...
This considerably
 ...
 proof scripts without loss of generality. For the informal pencil-and-paper proofs, the
 multi-variable case is just a routine adaptation, \hl{while the elegant formalisation
   of multi-variable equations is quite a challenge.} In Section~\ref{s:concl} some ideas
 are discussed.
