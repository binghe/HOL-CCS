...
For example, the result of substituting \hl{the} variable $X$ with $\nil$ in $a.X +
...
%  (i.e., a CCS expression with possibly
% free variables)\footnote{Rigorously speaking, under our setting
...
For instance, the solution of the equation $X \wb a. X$ 
is the process
...
\label{t:Mil89}
Let $E_i$ be guarded and sequential \hl{(with only guarded sums)}, and with free
