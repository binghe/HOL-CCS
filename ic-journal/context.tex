...
\HOLinline{\HOLTokenLambda{}\HOLBoundVar{t}.\\\;\HOLFreeVar{p}} is a
valid context, with  no
hole. 
% On the other hand, if any CCS term with recursion
...
\HOLinline{\HOLConst{SEQ}}, etc.)  were needed 
to capture properties about
 the
 relationships among these kinds of contexts and their
 composition. These proofs are usually tedious and long,  due to multiple levels of
...
precongruence is that the former  is an equivalence, while
 the latter can  just be  a preorder:
\begin{alltt}
