...
\item \begin{quote}
  ...
  notation for rooted bisimilarity following
  Gorrieri~\cite{Gorrieri:2015jt}, in which the superscript $c$ should be
  understood as a separate function or operator.
