...
\hl{Although weak bisimilarity is not compatible with an unrestricted
variant of binary choice, it is compatible with weakly guarded
sums. As a consequence, weak bisimilarity is indeed a ``congruence''
if we have had another version of \texttt{congruence} w.r.t. above \texttt{GCONTEXT}.}
%
