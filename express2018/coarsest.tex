...
contained in (weak) bisimilarity, namely the \emph{bisimilarity
  congruence} \cite{vanGlabbeek:2005ur}, can be constructed as
...
\texttt{CC\_def}, as with the trivial context $(\lambda x.\,x)$, $R\ g\ h$ becomes a conclusion.}}: (here $\subseteq_r$ stands for \emph{relational subset})
\begin{alltt}
...
itself may not be) is contained in the composition closure of $R$ (thus the coarsest one):}
\begin{alltt}
