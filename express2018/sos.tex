...
\end{lstlisting}
And the type ``\HOLinline{\ensuremath{\beta} \HOLTyOp{Action}}'' is the
...
column of Table \ref{tab:ccsoperator}; the table summarizes 
...
The rule \texttt{[REC]} (Recursion)
 says that if we substitute all appearances of variable $A$ in $E$ to
