...
\end{alltt}
\finish{notation above and below: all E' maybe should be P'} 
...
\finish{explain what \texttt{Hol_reln} is} 

A useful function that we have defined, exploiting the interplay
between HOL4 and Standard ML (and following an idea by Nesi \cite{...})
