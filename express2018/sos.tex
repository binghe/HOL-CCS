...
syntax\footnote{\hl{The order of type variables $\alpha, \beta$ can be
    arbitrary. Our choice is aligned with other CCS literals. Then
$\mathrm{CCS}(h,k)$ is the CCS subcalculus which can use at most $h$ constants
and $k$ actions.} \hl{Thus, to formalize theorems on such a 
calculus, it is enough to instantiate the type
