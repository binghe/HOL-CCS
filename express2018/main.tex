...
bisimialarity, in which only weak guardness is needed. However,
...
\emph{rooted bisimilarity} (hence also for bisimilarity itself) in which
true weakly guarded contractions (with direct sums) can be used. All
