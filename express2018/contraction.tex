...
$\contr$ of   Definition~\ref{d:expa}. Clause (1) is the same in the two
...
$\contr$, which explains the strictness of the inclusion
 ${\contr} \subseteq {\mcontrBIS}$. 
...
As  bisimilarity  and expansion, so 
contraction is preserved by all operators but sum.
