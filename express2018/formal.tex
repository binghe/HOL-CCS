...
proof scripts are in HOL4 official examples\footnote{\url{https://github.com/HOL-Theorem-Prover/HOL/tree/master/examples/CCS}}. The
...
plays three different roles: (The situation is quite different in
other systems like Coq\footnote{\hl{The Coq Proof Assistant.} \url{https://coq.inria.fr}}.)
\begin{enumerate}
