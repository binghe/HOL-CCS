...
(\texttt{FV}) and define guardedness directly on expressions of type CCS (instead of
CCS $\rightarrow$ CCS), then link to contexts. For instance, an expression is weakly-guarded when each
