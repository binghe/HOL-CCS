...
notably the trace equivalences as well as 
more refined calculi such as  value-passing CCS (e.g.,  exploiting the type variable
of actions).}

On another line, one could examine the formalisation of a different
