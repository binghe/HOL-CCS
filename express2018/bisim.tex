...
\end{alltt}
With above definitions, we can  define bisimulation relation exactly 
following Def.\;\ref{d:wb}.

For defining bisimilarity, there are two possibilities. 
The first, along the lines 
of Definition~\ref{d:wb}, defines it
 as the union of all bisimulations:
