...
\hl{If the list of actions is empty,  there is no transition and hence,}
if there is at most one visible action (i.e., a label) in the list of actions,
then the trace is also a weak transition. Here
we have to distinguish two cases: no label and unique label (in
...
following definition\footnote{A suggestion from Robert Beers}
