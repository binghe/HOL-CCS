...
\finish{sopra: sum-free} 
\section{Rooted contraction and unique solution for rooted bisimilarity}
\label{ss:new}
...
\finish{the only difference: the hat missing in the first clause} 
...
such that $R \mcontrBIS \ctp{\til P}$ and  $\ct{\til Q} \Arcap{\mu}
 \wb \ctp{\til Q}$.
\end{lemma}
\finish{sopra: si potrebbe togliere il hat, secondo me, e allora avremmo il risultato per
  rooted bisimilarity} 
